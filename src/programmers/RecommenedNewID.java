...
public class RecommenedNewID {
    ...
    public static void main(String[] args) {
        RecommenedNewID a = new RecommenedNewID();
        String newId = "z-+.^.";

        String recommenedId = a.solution(newId);
        System.out.println("Result : " + recommenedId);
    }
